...
#define GST_AJA_DEVICE_PROVIDER(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_AJA_DEVICE_PROVIDER,GstAjaDeviceProvider))
...
#define GST_AJA_DEVICE(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_AJA_DEVICE,GstAjaDevice))
